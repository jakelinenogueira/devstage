                ...
                {ranking.map((item, index) => {
                    ...
                    return(
                        <div key={item.id} className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3"> 
                            ...
                            {rankingPosition === 1 && <Image src={gold} alt="medal" className="absolute top-0 right-8"/>}
                            {rankingPosition === 2 && <Image src={silver} alt="medal" className="absolute top-0 right-8"/>}
                            {rankingPosition === 3 && <Image src={cooper} alt="medal" className="absolute top-0 right-8"/>}
                        </div>
                    )
                })}
            </div>
